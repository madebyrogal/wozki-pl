...
function form_select($options, $name, $label, $current, $auto, $multiple = false) {
  if ($label) {
    ?><label for="<?php echo $name; ?>"><?php echo $label; ?></label><br><?php }
  ?><select name="<?php echo $name; ?>" <?php if ($auto) { ?>onchange="this.form.submit();"<?php } ?> <?php if($multiple):?> multiple="multiple" size="35"<?php endif;?>>
  <?php
