...
<div id="content">  
  <div class="sTollbar">
    ...
    <div class="pagination">
      <a class="backPage" title="" href="<?= url_for('news') . '?page=' . $pager->getPreviousPage()?>"></a>
      <?php foreach($pager->getLinks() as $link):?>
      <a class="<?php if($link == $pager->getPage()):?>active<?php endif;?>" title="" href="<?= url_for('news') . '?page=' . $link?>"><?= $link?></a>
      <?php endforeach;?>
      <a class="nextPage" title="" href="<?= url_for('news') . '?page=' . $pager->getNextPage()?>"></a>
    </div>
    <?php endif;?>
  </div>  
  <ul class="news">
    ...
    <li>
      ...
      <p><?= $new->getSneakPeak()?> <a class="more" title="" href="<?= url_for('news_show', $new) . '?page=' . $pager->getPage()?>"><?= __("więcej")?></a></p>
    </li>
    <?php endforeach;?>
  </ul>
  <div class="clear"></div>
