...
<div id="content">
  ...
  <?php if ($pager->getNbResults()): ?>
    <?php if ($categoryHasAttribute): ?>
      <?= include_partial('offer/tiresListHeader', array('category' => $category, 'attribute' => $attribute, 'attributeDefValues' => $attributeDefValues, 'driveId' => $driveId)); ?>
    <?php endif; ?>
    <ul class="products">
        ...
        <li>
          <a title="" href="<?= url_for('offer_product', $product) ?>">
            ...
            <div class="productDetails">
              <?= include_component('offer', 'tiresListDetails', array('product' => $product)) ?>
